...
if __name__ == '__main__':
    ...
    graphs = RMN.read_graph_pickle('./')
    nx_graphs = graphs['LN_information']["nx_graph"]
    merge_graph = graphs['LN_information']["merge_graph"]

    # 加载社区的标签为其他任务使用
    name = 'LN_information_network'
    ground_truth_norm = graphs['LN_information']["comm_label"]
